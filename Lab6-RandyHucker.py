## Lab 6: Required Questions - Linked Lists  ##
...
def has_kitty_gene(dna):
    ...
    False
    """
    gene = link('C', link('A', link('T', link('C', link('A', link('T'))))))
...
def count_change(amount, denominations):
    ...
    deep_pass = count_change(amount, rest(denominations))
    surface_pass = count_change((amount - first(denominations)), denominations)
    return deep_pass + surface_pass
