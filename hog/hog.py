...
def is_swap(player_score, opponent_score):
    ...
    player_ones = (player_score - (player_tens*10))
    opponent_tens = (opponent_score // 10)
    opponent_ones = (opponent_score - (opponent_tens*10))
    if (player_tens == opponent_ones) and (player_ones == opponent_tens):
        return True
    return False
...
def play(strategy0, strategy1, update=simple_update,
